...
class TestReportingConfig:
    ...
    def test_default_config(self):
        ...
        assert ReportingConfig.log_to_file is False
    ...
    def test_configure_log_file(self):
        ...
        assert ReportingConfig.log_to_file is True
    ...
    def test_reset_config(self):
        ...
        ReportingConfig.configure(
            log_to_file=True, log_filepath="test.log", console_output=ConsoleOutput.NONE
        )
        ReportingConfig.reset()
        assert ReportingConfig.log_to_file is False
        assert ReportingConfig.log_filepath is None
...
class TestWarningTracking:
    ...
    def test_invalid_numeric_values_logged(self, tmp_path):
        ...
        invalid_warnings = [
            w for w in report.warnings if w.category in ["DATA_QUALITY", "NUMERICAL"]
        ]
    ...
    def test_curve_fit_failure_logged(self, tmp_path):
        ...
        [w for w in process_report.warnings if w.category == "CURVE_FIT"]
